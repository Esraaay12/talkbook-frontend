...
form.addEventListener("submit", (e) => {
  ...
  fetch("C:\Users\IMOE001\Documents\GitHub\twitter\handlers\signup.js", {
    method: "POST",
        ...
        <form action="index.html" method="post">
          ...
          <fieldset>
            ...
            <input
              ...
              name="user_interest"
            /><label class="light" for="development">Politics</label><br />
            <input
              type="checkbox"
              id="design"
              value="interest_design"
              name="user_interest"
            /><label class="light" for="design">Design & Fun </label><br />
            <input
              type="checkbox"
              id="business"
